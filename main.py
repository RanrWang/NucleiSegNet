...
a = tensorflow.config.experimental.list_physical_devices('GPU')
print(len(a))
# Path to the stain normalized patch 
valid_data_path = './dataset/ValidData/'
train_data_path = './dataset/TrainData/'
...
patch_size = 256
bs = 1 # batch size for training for validation it is taken 1
eps = 100 # epochs
...
lr_reducer = ReduceLROnPlateau(factor=0.1,patience=2,
                               cooldown= 5,
