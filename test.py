...
from utils.color_norm import patch_join
...
test_data_path = r'./dataset/TestData'
# Path to the full sized test mask for score computation
gt_path = r'./dataset/TestData/Bin/'
# Path to model weight and weight name
model_path = './checkpoint/'
# weight_name = 'weight_kumar_dataset.h5'
weight_name = 'nuclei_seg.h5'
# Path to save the segmented masks
if not os.path.exists("./consep_results"):
    os.mkdir("./consep_results")
sv_path = './consep_results'
