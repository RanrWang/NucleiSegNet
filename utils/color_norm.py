...
#----- # Test # ------#
Path("./dataset/TestData").mkdir(parents=True, exist_ok=True)
Path("./dataset/TestData/Bin").mkdir(parents=True, exist_ok=True) # for masks
Path("./dataset/TestData/tis").mkdir(parents=True, exist_ok=True) # for tissues

bin_p_ts = './dataset/TestData/Bin'
tis_p_ts = './dataset/TestData/tis'
#----- # Train # ------#
Path("./dataset/TrainData").mkdir(parents=True, exist_ok=True)
Path("./dataset/TrainData/Bin").mkdir(parents=True, exist_ok=True) # for masks
Path("./dataset/TrainData/tis").mkdir(parents=True, exist_ok=True) # for tissues

bin_p_tr = './dataset/TrainData/Bin/'
tis_p_tr = './dataset/TrainData/tis/'
#----- # Valid # ------#
Path("./dataset/ValidData").mkdir(parents=True, exist_ok=True)
Path("./dataset/ValidData/Bin").mkdir(parents=True, exist_ok=True) # for masks
Path("./dataset/ValidData/tis").mkdir(parents=True, exist_ok=True) # for tissues

bin_p_vl = './dataset/ValidData/Bin/'
tis_p_vl = './dataset/ValidData/tis/'

# Give path to your dataset
Train_image_path = './dataset/TrainData/tis/'
Train_mask_path = './dataset/TrainData/Bin/'

val_image_path = './dataset/ValidData/tis/'
val_mask_path = './dataset/ValidData/Bin/'

Test_image_path = './dataset/TestData/tis/'
test_mask_path = './dataset/TestData/Bin/'

# Give a reference image path for stain normalization
reference_image = './dataset/TestData/tis/0009-CD3-1-32.png'
